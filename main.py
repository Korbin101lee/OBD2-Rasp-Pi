...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def update_lcds(self):
        ...
        self.lcdNumber_4.display(values["fuel_pressure"])
        self.lcdNumber_5.display(values["egr_error"])
        self.lcdNumber_6.display(values["fuel_level"])
        self.lcdNumber_7.display(values["coolant_temp"])
        self.lcdNumber_8.display(values["intake_temp"])
        self.lcdNumber_9.display(values["run_time"])
        self.lcdNumber_10.display(values["air_flow_rate"])
        self.lcdNumber_11.display(values["barometric_pressure"])
        self.lcdNumber_12.display(values["command_egr"])
        self.lcdNumber_13.display(values["throttle_position"])
        self.lcdNumber_14.display(values["timing_advance"])
        self.lcdNumber_15.display(values["evaporative_purge"])
        self.lcdNumber_15.display(values["evap_vapor_pressure"])
